...
class GameScene: SKScene, SKPhysicsContactDelegate{
    ...
    func spawnPipes() {
        ...
        pipeDown.physicsBody = SKPhysicsBody(rectangleOfSize: CGSize(width: pipeDown.size.width, height: pipeDown.size.height - 10))
        ...
        pipeUp.physicsBody = SKPhysicsBody(rectangleOfSize: CGSize(width: pipeUp.size.width, height: pipeUp.size.height - 10))
